...
Flight::register('db', 'PDO', array('mysql:host=localhost;dbname=em1hzw3c_festes','em1hzw3c_appfest','#AppFestes2016'), function($db){
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
});

//Llistar tots els actes actuals ordenats per data ascendent
Flight::route('GET /', function(){
    $db=Flight::db();    
    $emp = $db->prepare('SELECT * FROM actes ORDER BY datahora ASC');
    $emp->execute();
